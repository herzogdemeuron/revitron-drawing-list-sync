...
class Config:
    ...
    def __init__(self):
        ...
        spaceSeparatorInput = config.get('spaceSeparatorCount', '0')
        self.spaceSeparatorCount = [int(x.strip()) for x in spaceSeparatorInput.split(',')] if ',' in spaceSeparatorInput else [int(spaceSeparatorInput)]